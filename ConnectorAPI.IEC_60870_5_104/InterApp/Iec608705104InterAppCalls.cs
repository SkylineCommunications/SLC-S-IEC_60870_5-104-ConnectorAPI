namespace Skyline.DataMiner.ConnectorAPI.IEC_60870_5_104.InterApp
{
	...
	using Skyline.DataMiner.ConnectorAPI.IEC_60870_5_104.Helpers;
	...
	/// <summary>
	/// Iec608705104InterAppCalls that contains all the generic information.
	/// </summary>
	public class Iec608705104InterAppCalls : IIec608705104InterAppCalls
	{
		...
		/// <summary>
		/// Initialize a new instance of the <see cref="Iec608705104InterAppCalls"/> class.
		/// </summary>
		/// <param name="connection">The connection interface.</param>
		/// <param name="elementName">The name of the element in DataMiner.</param>
		/// <exception cref="ArgumentNullException"></exception>
		/// <exception cref="ArgumentException"></exception>
		public Iec608705104InterAppCalls(IConnection connection, string elementName)
		{
		...
		/// <exception cref="ArgumentNullException"></exception>
		/// <exception cref="ArgumentException"></exception>
		public Iec608705104InterAppCalls(IConnection connection, int dmaId, int elementId)
		{
			if (dmaId == default)
			{
		...
		/// <inheritdoc/>
		public void SendMessageNoResponse(params IInterAppRequest[] messages)
		{
		...
		/// <inheritdoc/>
		public IEnumerable<IInterAppResponse> SendMessages(IInterAppRequest[] messages, TimeSpan timeout = default)
		{
		...
		/// <inheritdoc/>
		public IInterAppResponse SendSingleResponseMessage(IInterAppRequest message, TimeSpan timeout = default)
		{
			var interAppCallTimeout = timeout;
			if (timeout == default)
			{
